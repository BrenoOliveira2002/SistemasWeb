...
<body>
	...
	<main>
		...
		<form action="${linkServletAlterarProduto}" method="post">
			...
			<label>Descricao: <input type="text" name="descricao" value="${ produto.descricao }"/></label>
			<label>Qtd Previsto Mes: <input type="number" name="qtdPrevistoMes" value="${ produto.qtdPrevistoMes }"/></label>
			<label>Preco Max Comprado: <input type="number" name="precoMaxComprado" value="${ produto.precoMaxComprado }"/></label>
